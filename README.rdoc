...
At this point app should be working and you can check that in your rails console, however views are missing. Before adding views this article will describe on how to integrate Carrierwave and Cloudinary.
